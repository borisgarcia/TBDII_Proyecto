...
static const char qt_meta_stringdata_Delete[] = {
    "Delete\0\0on_btnBuscar_clicked()\0"
};
...
const QMetaObjectExtraData Delete::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Delete::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Delete,
      qt_meta_data_Delete, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Delete::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Delete))
