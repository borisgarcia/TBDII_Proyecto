...
static const char qt_meta_stringdata_eliminar[] = {
    "eliminar\0\0on_btnBuscar_clicked()\0"
};
...
const QMetaObjectExtraData eliminar::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject eliminar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_eliminar,
      qt_meta_data_eliminar, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &eliminar::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_eliminar))
